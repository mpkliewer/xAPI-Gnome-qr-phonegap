...
//        nfcApp.compileTemplates();
//        nfcApp.addTemplateHelpers();
//        nfcApp.showInstructions();
    },
...
//        tagContents.innerHTML = nfcApp.nonNdefTagTemplate(tag);    
...
//        nfcApp.nonNdefTagTemplate = Handlebars.compile(source);
//
//        source = document.getElementById('tag-template').innerHTML;
//        nfcApp.tagTemplate = Handlebars.compile(source);
//        
//    },
